        ...
        <section className="max-w-6xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-8 items-center">
            <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                    ...
                    <a href="/resume.pdf" className="px-4 py-2 rounded-lg border border-slate-200 text-sm bg-white hover:shadow" download>
                        Download Resume
                    </a>
        ...
        <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-sky-50 dark:from-slate-900 dark:via-slate-900 text-slate-900 dark:text-slate-100">
            <header className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
                ...
                <nav className="flex items-center space-x-4">
                    ...
                    <a href="/resume" className="inline-block ml-3 px-4 py-2 rounded-lg border border-slate-200 text-sm bg-white hover:shadow">
                        Resume
                    </a>
            ...
            <main className="max-w-6xl mx-auto px-6 pb-20">
                <Hero onCTAClick={(id) => scrollTo(id)} />
